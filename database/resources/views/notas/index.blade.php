            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br />
                        <br />
                        <form action="{{ route('notas.index') }}" method="GET" class="flex gap-2 pb-4 mx-16 w-full justify-center">
                                <input type="text" class="w-96 rounded-lg" name="buscador" value="{{ $buscar ?? '' }}" placeholder="Buscar notas por asignatura..." autocomplete="off">
                                <x-primary-button>
                                    buscar
                                </x-primary-button>
                        </form>
